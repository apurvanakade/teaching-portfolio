...
- **Rubric for proofs:**
  ...
  I designed the homework questions based on the textbook questions (for which the book provided detailed solutions) and gave students a rubric on which their writing would be graded. The rubric can be found in the [Appendix](#rubric-for-grading-proofs-for-discrete-math-course).
