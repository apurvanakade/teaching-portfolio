...
- **Excel Worksheets:**
  ...
  A sample worksheet can be found in the [Appendix](#sample-worksheet).
...
_University of Western Ontario, Fall 2020_
...
- **Rubric for proofs:**
  ...
  I designed the homework questions based on the textbook questions (for which the book provided detailed solutions) and gave students a rubric on which their writing would be graded. The rubric can be found in the [Appendix](#rubric-for-grading-proofs).
...
- **Discussion forums:**
  ...
  Anonymized version of my class' discussion forum can be found here: https://piazza.com/demo_login?nid=kd1rr8nxc6z4b5&auth=f76e59e
...
- **Mentor:**
  ...
  Notes from my Mathcamp classes can be found here: https://apurvanakade.github.io/for-students.html#canadausa.
